...
namespace jbp.core.oracle9i
{
    ...
    {
        public DocumentoPromotickMsg GetById(int idFactura) {
            var comillas = "\"";
            ...
            if (dt.Rows.Count > 0) {
                ...
                return new DocumentoPromotickMsg
                {
                    id = idFactura,
        ...
        public List<DocumentoPromotickMsg> GetFacturasToSendWsByMonth(string currentMonth)
        {
        ...
        public void InsertFactEnviada(DocumentoPromotickMsg me) {
            var sql = string.Format(@"
